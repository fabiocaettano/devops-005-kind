# $${\color{Black} Configurar \space Máquina \space Virual}$$
...
4. Na máquina local copiar o conteúdo da chave publica SSH:
...
7. Esta isso permitirá que a máquina remota possa clonar os repostiórios do git.

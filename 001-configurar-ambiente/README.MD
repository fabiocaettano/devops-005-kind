...
2. Voltar no site e colar a Public Key.

3. Informar o nome Public Key, o mesmo da máquia local.
...
3. Acessar a pasta com os manifestos:

``` bash
cd ansible
```

4. Executar PlaybooK Individualmente:
